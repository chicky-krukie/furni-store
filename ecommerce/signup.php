  ...
  <div class="row">
    ...
    <div class="col-md-6 align-self-center" id="login-center">
      ...
      <form id="login-form" method="POST">
        ...
        <center><button class="btn btn-lg btn-block col-md-7 mt-4" name="submit" type="submit">REGISTER</button></center>

      </form>

      <center><button class="btn-secondary btn-lg btn-block col-md-7 rounded-0" id="login" type="submit">LOGIN</button></center>
...
if(isset($_POST['submit'])) {
  ...
  $query = $connect->query("INSERT INTO user SET username = '$username', pass = '$password'");
